...
from data.referential import get_referential_for_agent3

# ── Référentiel Decathlon ─────────────────────────────────────────────────────

# REFERENTIEL loaded dynamically from data/legal_categories.json
REFERENTIEL = get_referential_for_agent3()
