...
STRICT RULE: CAT1 applies ONLY when the product IS a battery (e.g. a pack of AA batteries,
a Li-ion battery pack sold separately). If a product simply USES or CONTAINS batteries as
its power source (e.g. a headlight powered by AA batteries), CAT1 does NOT apply.
When in doubt, do NOT assign CAT1.
