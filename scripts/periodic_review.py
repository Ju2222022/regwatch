        ...
        for entry in new_entries:
            ...
            <tr>
              ...
              <td style="padding:8px;border-bottom:1px solid #eee">
                <a href="{entry.get('url','#')}" style="color:#2554d4">{entry.get('title','')}</a>
              </td>
              <td style="padding:8px;border-bottom:1px solid #eee;color:{color};font-weight:700">{urgency}</td>
              <td style="padding:8px;border-bottom:1px solid #eee;font-size:12px;color:#666">{entry.get('summary','')[:150]}…</td>
            </tr>"""
...
<body style="font-family:Segoe UI,sans-serif;max-width:800px;margin:0 auto;padding:20px">
  ...
  <div style="background:#f8f9ff;padding:16px;border-left:4px solid #1a3a8f">
    <strong>{total_new} new alert(s)</strong> identified this period
    {"· <span style='color:#d32f2f;font-weight:700'>" + str(high_count) + " HIGH urgency</span>" if high_count else ""}
  </div>
